...
public class ClothWSingleStytle extends DataSupport implements Serializable {
    private int type;
    ...
    public ClothWSingleStytle() {
    }

    public ClothWSingleStytle(String goodsCode, String goodsName, String goodsStyleCode, int goodsPrice, String goodsBrand) {
